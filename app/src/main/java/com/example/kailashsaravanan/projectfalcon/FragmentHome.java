...
public class FragmentHome extends Fragment
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @android.support.annotation.Nullable ViewGroup container, @android.support.annotation.Nullable Bundle savedInstanceState) {
        ...
        mOutputText = view.findViewById(R.id.output);
...
//                                    Toast.makeText(main, "Hello", Toast.LENGTH_SHORT).show();
    ...
    private void getResultsFromApi() {
        if (! isGooglePlayServicesAvailable()) {
            ...
            new FragmentHome.MakeRequestTask(mCredential).execute();
        }
    }
...
//            mProgress.hide();
    ...
    public void sendNotification(){
        ...
        PendingIntent actionIntent = PendingIntent.getBroadcast(getContext(), 0, new Intent(getContext(), main.getClass()), PendingIntent.FLAG_UPDATE_CURRENT);

        final NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(getContext(), CHANNEL_ID)
